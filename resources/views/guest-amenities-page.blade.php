  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="/amenities">Amenities<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/breakfast">Breakfast Selection</a>
      </li>
...
<!-- Amenities cards -->
<div class="card-deck" style="margin-left: 10px; margin-right: 10px; margin-top: 20px;">
  <div class="card">
    <img class="card-img-top" src="images/amenities-2.jpg" alt="Card image cap">
    <div class="card-body">
      <h5 class="card-title">Amenity 1</h5>
      <p class="card-text">Place a request for an additional amenity</p>
      <button type="submit" class="btn btn-primary" style="width: 100%; margin-top: 20px; background: #1E261D; border: none;">Request</button>
    </div>
  </div>
  <div class="card">
    <img class="card-img-top" src="images/amenities-2.jpg" alt="Card image cap">
    <div class="card-body">
      <h5 class="card-title">Amenity 2</h5>
      <p class="card-text">Place a request for an additional amenity</p>
      <button type="submit" class="btn btn-primary" style="width: 100%; margin-top: 20px; background: #1E261D; border: none;">Request</button>
    </div>
  </div>
  <div class="card">
    <img class="card-img-top" src="images/amenities-2.jpg" alt="Card image cap">
    <div class="card-body">
      <h5 class="card-title">Amenity 3</h5>
      <p class="card-text">Place a request for an additional amenity</p>
      <button type="submit" class="btn btn-primary" style="width: 100%; margin-top: 20px; background: #1E261D; border: none;">Request</button>
    </div>
  </div>
